			...
			<div class="container">
				<div id="wrap-feature">
					<div class="one-third column feature">
						...
						<p class="indent">
							รับออกแบบ และพัฒนาเว็บไซต์ สำหรับ หน่วยงาน บริษัท หรือ บุคคลทั่วไป โดยทีมงาน Web Design ที่มีความเชี่ยวชาญ 					                             สามารถออกแบบเว็บไซต์ได้ตรงตามความต้องการ รวดเร็ว มีเอกลักษณ์ และเหมาะสมกับธรุกิจนั้นๆ ไม่ว่าจะเป็น
							เว็บแนะนำองค์กร (Content Website) เว็บไซต์สำหรับผู้ที่ต้องการทำร้านค้าออนไลน์ (E-Commerce Website) พร้อมระบบ 							 สั่งซื้อสินค้า, ล๊อคอิน, ลงทะเบียน และเว็บบอร์ด เว็บไซต์รองรับการชำระเงิน เพื่อเพิ่มความสะดวกแก่ผู้ใช้
						</p>
					...
					<div class="one-third column feature">
						...
						<p class="indent">
							ปัจจุบันโทรศัพท์มือถือ ถือเป็นสิ่งจำเป็น เนื่องจากการทำงาน การใช้ชีวิตไม่ได้อยู่กับที่ Mobile Application 	 				  							จะทำให้สามารถเข้าถึงธุรกิจของคุณได้มากขึ้นไม่ว่าจะอยู่ที่ไหน รับออกแบบและพัฒนา IPhone และ Andoird Application
							โดยทีมงานที่มีความเชี่ยวชาญ สามารถพัฒนาโดยเชื่อมต่อกับ Facebook, การถ่ายรูป Upload รูปออนไลน์, การใช้ QR Code, Map 							หรือการเชื่อมต่อกับ Web Service และ Function อื่นๆตามความต้องการ
						</p>
					...
					<div class="one-third column feature">
						...
						<p class="indent">
							Augmented Reality เป็น Technology ที่รวมระหว่างสิ่งแวดล้อมจริงและ สิ่งแวดล้อมเสมือนเข้าด้วยกัน 				 						 โดยผู้ใช้สามารถดูผ่านอุปกรณ์กล้องโทรศัพท์มือถือ รวมกับการใช้ Application ซึ่งจะทำให้เราเห็นภาพในจอ
							...
							ทำนามบัตร, สื่อการเรียนการสอน, หรือใช้เพื่อสร้างความบันเทิง
						</p>
					</div>
				</div>
